...
public class NabilahServerSSL {
public static final boolean DEBUG = true;
 public static final int HTTPS_PORT = 443;//80, Tukar port untuk uji SSL(443) dan tanpa SSL (80) 
 public static final String KEYSTORE_LOCATION = "C:\\Program Files\\Java\\jdk1.8.0_181\\bin\\secNabilah.jks";
 ...
 NabilahServerSSL server = new NabilahServerSSL();
 server.startServer();
 }
